...
describe('Cloner', () => {
  it('solo game preserved', () => {
    const player = new Player('old-player1', 'yellow', true, 9, 'p-old-player1-id', undefined);
    const game = Game.newInstance(
      'g-old-game-id', [player], player, {
        turmoilExtension: true,
      }, -5179823149812374);

    const newPlayer = new Player('new-player1', 'red', false, 3, 'p-new-player1-id', undefined);
