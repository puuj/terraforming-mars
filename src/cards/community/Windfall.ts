  ...
  constructor() {
    super({
      ...
      metadata: {
        ...
        description: 'Must have TR over 30, at least 1 tag of Building, Space, Science, Power, Earth, Jovian, Plant, Microbe, Animal, and City, and at least 1 production of MC, steel, titanium, plants, energy, and heat. Draw 4 cards and gain all production (with TR).',
      },
    });
  }
