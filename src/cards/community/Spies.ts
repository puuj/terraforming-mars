    ...
    availablePlayerTargets.forEach((target) => {
      if (target.megaCredits > 0) {
        ...
        availableActions.options.push(new SelectOption(optionTitle, 'Confirm', () => {
          ...
          target.setResource(Resources.MEGACREDITS, -1, player.game, player);
          return undefined;
        }));
      }
      ...
      if (target.steel > 0 && !target.alloysAreProtected()) {
        ...
        availableActions.options.push(new SelectOption(optionTitle, 'Confirm', () => {
          ...
          target.setResource(Resources.STEEL, -1, player.game, player);
          return undefined;
        }));
      }
      ...
      if (target.titanium > 0 && !target.alloysAreProtected()) {
        ...
        availableActions.options.push(new SelectOption(optionTitle, 'Confirm', () => {
          ...
          target.setResource(Resources.TITANIUM, -1, player.game, player);
          return undefined;
        }));
      }
      ...
      if (target.plants > 0 && !target.plantsAreProtected()) {
        ...
        availableActions.options.push(new SelectOption(optionTitle, 'Confirm', () => {
          ...
          target.setResource(Resources.PLANTS, -1, player.game, player);
          return undefined;
        }));
      }
      ...
      if (target.energy > 0) {
        ...
        availableActions.options.push(new SelectOption(optionTitle, 'Confirm', () => {
          ...
          target.setResource(Resources.ENERGY, -1, player.game, player);
          return undefined;
        }));
      }
      ...
      if (target.heat > 0) {
        ...
        availableActions.options.push(new SelectOption(optionTitle, 'Confirm', () => {
          ...
          target.setResource(Resources.HEAT, -1, player.game, player);
          return undefined;
        }));
      }
    });
