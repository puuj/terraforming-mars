...
import {CardsInHandRequirement} from './CardsInHandRequirement';
import {CardsPlayedRequirement} from './CardsPlayedRequirement';
...
class Builder {
  ...
  public cardsInHand(amount?: number, options?: Options): this {
    this.reqs.push(new CardsInHandRequirement(amount, options));
    return this;
  }

  public cardsPlayed(amount?: number, options?: Options): this {
    this.reqs.push(new CardsPlayedRequirement(amount, options));
    return this;
  }
